...
public class UpdateChecker extends Thread {
    ...
    public void run()
    {
        // URL of the BetterRecycling resource.
        URL url = null;

        try
        {
            // Get the latest version of the BetterRecycling resource.
            url = new URL("https://api.spigotmc.org/legacy/update.php?resource=93631");
        }
        ...
        try
        {
            ...
            if (latestVersion.equalsIgnoreCase( currentVersion ))
            {
                ...
                Bukkit.getLogger().info("[BetterRecycling] You are using the latest version: " + currentVersion);
            }
            else {
                // Message that you're using an older version of BetterRecycling.
                Bukkit.getLogger().info("[BetterRecycling] You are using " + currentVersion + " and the latest release is " + latestVersion);
            }
        }
        catch (IOException | NullPointerException e)
        {
